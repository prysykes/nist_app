# Generated by Django 5.0.1 on 2024-02-05 02:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster_id', models.ForeignKey(default='cluster_id', on_delete=django.db.models.deletion.CASCADE, to='pages.category')),
            ],
        ),
    ]
