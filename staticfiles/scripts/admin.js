...
function show_json_txt_dir_input(){
    ...
    yt_file_type_select.addEventListener('change', (e)=>{
        ...
        if (selected == 'json'){
            ...
            json_dir_input.classList.toggle('display-none', false);
            txt_dir_input.classList.toggle('display-none', true); 
            
        }
        else if (selected == 'text'){
            let txt_dir_input = document.querySelector('#txt_dir_input')

            txt_dir_input.classList.toggle('display-none', false);
            json_dir_input.classList.toggle('display-none', true);  
        }
    })
